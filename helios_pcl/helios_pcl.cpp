/***************************************************************************************
 ***                                                                                 ***
 *** Example for getting PCL Type Point Cloud from a LUCID VISION Helios Device.     ***
 *** Major portion has been adopted from a LUCID VISION Code Example.                ***
 *** Regarding Copyright is stated below.                                            ***
 *** Ahn, Jeeho                                                                      ***
 ***                                                                                 ***
 ***************************************************************************************/
